...
type ViewType = "projects" | "series" | "project-settings" | "user-settings"
...
FADE TO:`,
  ...
  if (currentView === "project-settings") {
    return <ProjectSettings onBack={() => setCurrentView("series")} />
  }

  if (currentView === "user-settings") {
    return <UserSettings onBack={() => setCurrentView(selectedSeries ? "series" : "projects")} />
  }
  ...
  return (
    <div className="flex h-screen flex-col bg-background overflow-hidden">
      <SeriesHeader
        ...
        onOpenProjectSettings={() => setCurrentView("project-settings")}
        onOpenUserSettings={() => setCurrentView("user-settings")}
      />
