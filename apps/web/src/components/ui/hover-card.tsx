...
function HoverCardArrow({ className, ...props }: ComponentProps<typeof HoverCardPrimitive.Arrow>) {
  return <HoverCardPrimitive.Arrow data-slot="hover-card-arrow" className={cn('fill-popover', className)} {...props} />;
}
