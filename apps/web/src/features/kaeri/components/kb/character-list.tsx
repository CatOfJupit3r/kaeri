...
import { useCharacterList } from '@~/features/kaeri/hooks/queries/use-character-list';
            ...
            <Card key={character._id} className="group cursor-pointer overflow-hidden transition-all hover:shadow-md">
              <CardContent className="flex gap-4 p-4">
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                  <h3 className="truncate font-semibold text-foreground group-hover:text-primary">{character.name}</h3>
