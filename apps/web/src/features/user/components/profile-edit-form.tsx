...
import type { MeQueryResultType } from '../hooks/use-me';
import { useUpdateUserProfile } from '../hooks/use-update-user-profile';

type UserProfile = ORPCOutputs['user']['getUserProfile'];

interface iProfileEditFormProps {
  user: NonNullable<MeQueryResultType>['user'];
  profile: UserProfile;
}

export function ProfileEditForm({ user, profile }: iProfileEditFormProps) {
