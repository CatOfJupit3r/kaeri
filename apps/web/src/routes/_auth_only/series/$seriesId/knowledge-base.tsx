...
import { LuBookUser, LuGlobe, LuPackage, LuCalendar, LuSparkles, LuLightbulb } from 'react-icons/lu';
import z from 'zod';
...
const tabSchema = z.enum(['characters', 'locations', 'props', 'timeline', 'wildcards', 'themes']);
